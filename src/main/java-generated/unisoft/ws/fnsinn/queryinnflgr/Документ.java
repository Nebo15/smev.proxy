...
package unisoft.ws.fnsinn.queryinnflgr;
 ...
 *                   &lt;/simpleType>
 *                 &lt;/attribute>
 *                 &lt;attribute name="ИННЮЛ" use="required" type="{http://ws.unisoft/FNSINN/queryINNFLGR}ИННЮЛТип" />
 *                 &lt;attribute name="ОГРН" use="required" type="{http://ws.unisoft/FNSINN/queryINNFLGR}ОГРНТип" />
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="Запрос" maxOccurs="100">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="ФИО" type="{http://ws.unisoft/FNSINN/queryINNFLGR}ФИОТип"/>
 *                             &lt;element name="УдЛичнФЛ">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;attribute name="КодВидДок" use="required" type="{http://ws.unisoft/FNSINN/queryINNFLGR}СПДУЛТип" />
 *                                     &lt;attribute name="СерНомДок" use="required" type="{http://ws.unisoft/FNSINN/queryINNFLGR}СПДУЛШТип" />
 *                                     &lt;attribute name="ДатаДок" type="{http://ws.unisoft/FNSINN/queryINNFLGR}ДатаТип" />
 ...
 *                             &lt;/element>
 *                           &lt;/sequence>
 *                           &lt;attribute name="ДатаРожд" use="required" type="{http://ws.unisoft/FNSINN/queryINNFLGR}ДатаТип" />
...
public class Документ {
    ...
    protected List<Документ.Запрос> запрос;
     ...
     * This is why there is not a <CODE>set</CODE> method for the запрос property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getЗапрос().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link Документ.Запрос }
     * 
     * 
     */
    public List<Документ.Запрос> getЗапрос() {
        if (запрос == null) {
            запрос = new ArrayList<Документ.Запрос>();
        }
        return this.запрос;
    }
    ...
    public static class Запрос {
        ...
        protected Документ.Запрос.СвФЛ свФЛ;
         ...
         * @return
         *     possible object is
         *     {@link Документ.Запрос.СвФЛ }
         *     
         */
        public Документ.Запрос.СвФЛ getСвФЛ() {
            return свФЛ;
        }
         ...
         *     
         */
        public void setСвФЛ(Документ.Запрос.СвФЛ value) {
            this.свФЛ = value;
        }
        ...
        public static class СвФЛ {
            ...
            protected Документ.Запрос.СвФЛ.УдЛичнФЛ удЛичнФЛ;
             ...
             * @return
             *     possible object is
             *     {@link Документ.Запрос.СвФЛ.УдЛичнФЛ }
             *     
             */
            public Документ.Запрос.СвФЛ.УдЛичнФЛ getУдЛичнФЛ() {
                return удЛичнФЛ;
            }
             ...
             *     
             */
            public void setУдЛичнФЛ(Документ.Запрос.СвФЛ.УдЛичнФЛ value) {
                this.удЛичнФЛ = value;
            }
