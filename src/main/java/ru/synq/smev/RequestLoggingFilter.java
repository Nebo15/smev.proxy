...
public class RequestLoggingFilter extends OncePerRequestFilter {
    ...
    public static interface RequestAcceptor {
    ...
    public static class Builder {
        ...
        private RequestAcceptor acceptor = new RequestAcceptor() {
            @Override
            public boolean accept(String method, String uri, String query, String contentType) {
                return true;
            }
        };
        ...
        public RequestLoggingFilter build() {
            return new RequestLoggingFilter(excludes.build(), acceptor, replaces.build());
        }
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (responseToUse instanceof ContentCachingResponseWrapper) {
                ...
                responseLog.info("body=" + doReplaces(new String(body, wrapper.getCharacterEncoding())));
    ...
    private RequestLoggingFilter(ImmutableSet<String> excludes, RequestAcceptor acceptor, ImmutableList<ReplaceSpec> replaces) {
