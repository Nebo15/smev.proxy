...
public class LocalSignatureAction implements Action {
    public void execute(WSHandler handler, int actionToDo, Document doc, RequestData reqData)
        ...
        if (reqData.getSigAlgorithm() != null) {
        	String s =  reqData.getSigAlgorithm();
        ...
        try {
            ...
            for (WSEncryptionPart part : reqData.getSignatureParts()) {
                ...
                } else if (true&&/*reqData.isAppendSignatureAfterTimestamp()
            ...
            if (true&&/*reqData.isAppendSignatureAfterTimestamp() &&*/ siblingElementToPrepend == null) {
