...
 */
package ru.synq.smev.soap.ws.security.message;
...
/**
 *  * Переопределяем базовый объект WSSecSignature.  * Цель - подставить DOM
 * Provider "CryptoProXMLDSig" вместо базового "ApacheXMLDSig".  * @author
 * Aleksey Sushko  *  
 */
