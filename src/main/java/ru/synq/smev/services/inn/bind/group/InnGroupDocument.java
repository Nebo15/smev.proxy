...
public class InnGroupDocument {
    ...
    public static class Запрос {
        ...
        public static class СвФЛ {
            ...
            @NotNull @Valid
            protected ru.synq.smev.services.inn.bind.individual.ФИОТип ФИО;
            ...
            public ru.synq.smev.services.inn.bind.individual.ФИОТип getФИО() {
                return ФИО;
            }

            public void setФИО(ru.synq.smev.services.inn.bind.individual.ФИОТип ФИО) {
                this.ФИО = ФИО;
            }
