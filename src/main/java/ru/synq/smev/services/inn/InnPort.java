...
//    @RequestWrapper(localName = "queryINNFL", targetNamespace = "http://ws.unisoft/", className = "ru.synq.smev.soap.inn.INNFL")
    ...
    public InnResponse queryIndividual(@WebParam(name = "queryINNFL", targetNamespace = "http://ws.unisoft/") InnIndividualRequest baseMessage);
    ...
    public InnResponse queryGroup(@WebParam(name = "queryINNFLGR", targetNamespace = "http://ws.unisoft/") InnGroupRequest baseMessage);
}
