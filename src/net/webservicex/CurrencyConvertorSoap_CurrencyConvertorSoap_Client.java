...
public final class CurrencyConvertorSoap_CurrencyConvertorSoap_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        net.webservicex.Currency conversionRate_fromCurrency = Currency.USD;
        net.webservicex.Currency conversionRate_toCurrency = Currency.UAH;
        double conversionRate__return = port.conversionRate(conversionRate_fromCurrency, conversionRate_toCurrency);
        System.out.println("conversionRate.result=" + conversionRate__return);
