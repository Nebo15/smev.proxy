 ...
 * 2014-11-13T00:29:48.063+02:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CurrencyConvertor", 
                  wsdlLocation = "currency.wsdl",
...
public class CurrencyConvertor extends Service {
    ...
    static {
        URL url = CurrencyConvertor.class.getResource("currency.wsdl");
        System.out.println("url1 = "+url);
        if (url == null) {
            url = CurrencyConvertor.class.getClassLoader().getResource("currency.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(CurrencyConvertor.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "currency.wsdl");
        }       
        WSDL_LOCATION = url;
